...
namespace L02_P02__2018_RR_604__2015_CG_601.Controllers
{
    public class clientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("clienteId,nombreCliente")] clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("clienteId,nombreCliente")] clientes clientes)
        {
